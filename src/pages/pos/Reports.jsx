...
const Reports = () => {
  ...
  const printReceipt = (bill) => {
    ...
    // In a real robust app, you'd generate a separate printable component or window.
  ...
  return (
    <div className="animate-fade-in" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', background: 'var(--card-bg)', borderRadius: 'var(--radius)', border: '1px solid var(--border-color)', overflowX: 'hidden' }}>
